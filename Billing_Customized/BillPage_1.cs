...
{
    public partial class BillPage_1 : Form
    {
        private Cashier cashier;
        private List<StockDetail> availableProducts;
        private BackgroundWorker backgroundWorker;
        private static BillPage_1 billPage;
        public bool isBillPrinted = false;
        private string billNumber;

        public static BillPage_1 Singelton
        {
            get
            {
                if (billPage == null)
                {
                    billPage = new BillPage_1();
                }
                return billPage;
            }
            set
        ...
        private void BilledProducts_GridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
